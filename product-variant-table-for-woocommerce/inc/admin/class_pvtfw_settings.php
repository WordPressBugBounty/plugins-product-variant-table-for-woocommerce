        ...
        **/
        ...
        ?>
            ...
            <div class="wrap pvtfw-variant-table-setting-wrap">
                <h1>
                    <?php echo esc_html('Product Variation Table for WooCommerce Settings', 'product-variant-table-for-woocommerce'); ?> 
                    <?php echo wp_kses_post( apply_filters( 'pvtfw_version_title', sprintf( 
                ...
                <nav class="nav-tab-wrapper">
                    <?php 
                        ...
                        echo wp_kses_post( apply_filters('pvtfw_admin_setting_tab', $tab, $curTab) );
                    ?>
                </nav>
